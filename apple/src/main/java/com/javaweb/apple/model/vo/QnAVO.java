...
public class QnAVO {
	private int	qId; //(관리번호) int <<PK>> NN AI
	private String title; //(게시판명) varchar(20) default=QnA NN
	...
	public QnAVO(String postTitle, String postContents) {
		super();
	...
	public QnAVO(int qId, String title, String postTitle, int postId, int readCount, String postContents,
	...
	public String toString() {
		return "QnAVO [qId=" + qId + ", title=" + title + ", postTitle=" + postTitle + ", postId=" + postId
