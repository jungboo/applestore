...
<div class="wrapper">	
	...
	<form action="${pageContext.request
		.contextPath}/nt_update.ap" method="post">
		...
		<table class="piece">
			...
			<tr> 
				<th>제목:</th> 
				<td>
					<input type="text" name="postTitle" value="${notice.postTitle}">
				</td>
			</tr>
			...
			<tr> 
				...
				cols="64"><c:out value="${notice.postContents}"
